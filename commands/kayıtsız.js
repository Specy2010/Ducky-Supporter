...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        message.channel.send(embed.setDescription("Kullanıcı başarılı bir şekilde `kayıtsıza` atılmıştır!")).then(message.react(client.config.tik));
